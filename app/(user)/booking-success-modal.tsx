...
export default function BookingSuccessModalScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.modalCard}>
        ...
        <Text style={styles.modalMessage}>Thanks for booking. We look forward to serving you!!</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.dismissTo('/(user)/(tabs)/appointments')}
        >
