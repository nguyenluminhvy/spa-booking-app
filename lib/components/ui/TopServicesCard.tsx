...
const mockTopServices = [
  { id: 1, name: "Massage Body", bookings: 120 },
  { id: 2, name: "Facial Care", bookings: 95 },
  { id: 3, name: "Hair Spa", bookings: 80 },
];
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1, alignItems: "center" }}>
        <Text style={{ textAlign: 'right', fontSize: 12, fontWeight: isHeader ? "600" : "400", width: 30 }}>
          {bookings}
        </Text>
      </View>
    </View>
...
export const TopServicesCard = ({ data = [] }: any) => {

  return (
    <View style={[styles.cardChart, { flex: 1 }]}>
      <Text style={styles.titleChart}>🏆  Top Booking Services</Text>
